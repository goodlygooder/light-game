...
Menu.prototype = {
    preload: function() {
        ...
        game.load.audio('drone', ['assets/audio/Ambient drones.mp3', 'assets/audio/Ambient drones.ogg'] );
...
House.prototype = {
     preload: function() {
        ...
        //https://freesound.org/people/FlechaBr/sounds/340161/
        game.load.audio('roar', ['assets/audio/roar.mp3', 'assets/audio/roar.ogg'] );
    ...
    create: function() {
        console.log("House: create");
        	...
        	qTimer = game.time.create(false);
       		...
       		firstHandSpawn = game.time.create(false);
       		firstHandSpawn.add(Phaser.Timer.SECOND * 15, this.firstHandSpawn, this);
       		firstHandSpawn.start();
    ...
    firstHandSpawn: function()
    {
        ...
        handSpawnTimer = game.time.create(false);
       	handSpawnTimer.loop(Phaser.Timer.SECOND * 5, this.handSpawn, this);
       	handSpawnTimer.start();
    },
...
Win.prototype = {
     preload: function() {
        ...
        game.load.atlas('crouch', 'assets/img/crouch.png', 'assets/img/crouch.json');
    },
    ...
    create: function() {
        ...
        player = game.add.sprite(250, 200, 'crouch');
        player.scale.setTo(.75, .75);
        player.animations.add('crouch', ['crouch1.png', 'crouch2.png', 'crouch3.png', 'crouch4.png', 'crouch5.png', 'crouch6.png', 'crouch7.png', 'crouch8.png'], 6);
